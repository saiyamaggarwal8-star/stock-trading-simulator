...
public class PatternDetectionService {
    ...
    private void detectTripleBottom(List<CandleDTO> candles, List<PatternDTO> detected) {
        ...
        if (lowIndices.size() >= 3) {
            // Get the 3 most recent valleys identified
            int i1 = lowIndices.get(lowIndices.size() - 3);
            int i2 = lowIndices.get(lowIndices.size() - 2);
            int i3 = lowIndices.get(lowIndices.size() - 1);
    ...
    private void detectGeneralTrend(List<CandleDTO> candles, List<PatternDTO> detected) {
        ...
        // If overall 2% gain, consider it an uptrend
